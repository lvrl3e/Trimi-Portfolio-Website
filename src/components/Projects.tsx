    ...
    <section id="projects" className="relative px-6 py-28 sm:py-36">
      <div className="mx-auto max-w-5xl">
        <Reveal className="mx-auto max-w-xl text-center">
          ...
          <p className="mt-3 text-slate-400">Some things I've been building.</p>
        </Reveal>

        {featured && (
          <Reveal delay={100} className="mt-16">
            <div className="group relative overflow-hidden rounded-3xl border border-violet/30 bg-gradient-to-br from-white/[0.04] to-white/[0.01] p-1 transition-all duration-500 hover:border-violet/50">
                ...
                <div className="flex flex-col justify-center p-8 sm:p-10">
                  ...
                  <div className="mt-7 flex gap-3">
                    <a
                      ...
                      className="flex items-center gap-2 rounded-full border border-white/15 px-5 py-2.5 text-sm font-medium text-slate-200 transition-all duration-300 hover:border-violet/50 hover:bg-white/5"
                    >
                      <GithubIcon size={16} />
                      GitHub
                    </a>
        ...
        <div className="mt-8 grid gap-6 sm:grid-cols-2">
          {rest.map((project, i) => (
            <Reveal key={project.name} delay={i * 100}>
              <div className="group relative h-full overflow-hidden rounded-2xl border border-white/10 bg-white/[0.02] transition-all duration-300 hover:-translate-y-1 hover:border-violet/30 hover:shadow-[0_20px_50px_-20px_rgba(139,92,246,0.35)]">
                ...
                <div className="p-6">
                  ...
                  <div className="mt-5 flex gap-3">
                    <a
                      ...
                      className="flex items-center gap-1.5 text-sm font-medium text-slate-300 transition-all duration-300 hover:text-violet-bright"
                    >
                    ...
                    {project.liveUrl && (
                      <a
                        ...
                        className="flex items-center gap-1.5 text-sm font-medium text-slate-300 transition-all duration-300 hover:text-blue-bright"
                      >
