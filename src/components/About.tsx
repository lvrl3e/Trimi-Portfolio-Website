...
const CODE_LINES = [
  { indent: 0, text: "const trimi = {", color: "text-fg-muted" },
  ...
  { indent: 0, text: "};", color: "text-fg-muted" },
];
    ...
    <section id="about" className="relative px-6 py-28 sm:py-36">
      <div className="mx-auto max-w-5xl">
        <Reveal className="mx-auto max-w-xl text-center">
          <h2 className="text-3xl font-bold text-fg sm:text-4xl">About Me</h2>
          <p className="mt-3 text-fg-muted">Building ideas into useful digital experiences.</p>
        </Reveal>
          ...
          <Reveal delay={200}>
            <div className="relative mx-auto max-w-sm">
              ...
              <div className="relative overflow-hidden rounded-2xl border border-border-subtle bg-surface shadow-2xl">
                <div className="flex items-center gap-1.5 border-b border-border-subtle bg-tint-1 px-4 py-3">
                  <span className="h-2.5 w-2.5 rounded-full bg-red-400/70" />
                  <span className="h-2.5 w-2.5 rounded-full bg-yellow-400/70" />
                  <span className="h-2.5 w-2.5 rounded-full bg-green-400/70" />
                  <span className="ml-2 flex items-center gap-1.5 text-xs text-fg-subtle">
                    <Terminal size={12} />
                    about.ts
                  </span>
                </div>
